...
<p><code>Rails.root: /Users/rtass001/Documents/projects/wyncode_projects/wyndex</code></p>
...
<table id='route_table' class='route_table'>
  ...
  <td data-route-name='coders'>
      coders<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/coders(.:format)' data-regexp='^\/coders(?:\.([^\/.?]+))?$'>
    /coders(.:format)
  </td>
  <td data-route-reqs='coders#index'>
    coders#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='coders#create'>
    coders#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_coder'>
      new_coder<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/coders/new(.:format)' data-regexp='^\/coders\/new(?:\.([^\/.?]+))?$'>
    /coders/new(.:format)
  </td>
  <td data-route-reqs='coders#new'>
    coders#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_coder'>
      edit_coder<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/coders/:id/edit(.:format)' data-regexp='^\/coders\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /coders/:id/edit(.:format)
  </td>
  <td data-route-reqs='coders#edit'>
    coders#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='coder'>
      coder<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/coders/:id(.:format)' data-regexp='^\/coders\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /coders/:id(.:format)
  </td>
  <td data-route-reqs='coders#show'>
    coders#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='coders#update'>
    coders#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='coders#destroy'>
    coders#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='coders#home'>
    coders#home
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='index'>
      index<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/index(.:format)' data-regexp='^\/index(?:\.([^\/.?]+))?$'>
    /index(.:format)
  </td>
  <td data-route-reqs='coders#indexalt'>
    coders#indexalt
  </td>
</tr>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;ympFNeHtlhVROsoEtRhOHgBp60/MrclVHhhEvfEqAww=&quot;
session_id: &quot;fdcffaa03d332b0946a8d910dc1b8d5b&quot;</pre></div>
</div>
...
<div id="console"
  ...
  data-session-id='075eaf824d50430300be0374905e8c2e'
  data-prompt-label='>> '>
</div>
